...
describe("narrow phase contacts", () => {
    ...
    test("every manifold field reads back a sane resting contact", () => {
        ...
        world.contactPair(bodyCollider, groundCollider, (manifold) => {
            ...
            for (let i = 0; i < n; i++) {
                ...
                expect(Number.isFinite(manifold.contactTangentImpulse(i))).toBe(true);
            ...
            expect(Math.hypot(tangentVelocity.x, tangentVelocity.y)).toBeCloseTo(0, 5);
        });
    ...
    test("an out-of-range contact index reads as null or zero", () => {
        ...
        world.contactPair(bodyCollider, groundCollider, (manifold) => {
            ...
            expect(manifold.contactTangentImpulse(n)).toBe(0);
    ...
    test("colliders that are not touching yield no manifold", () => {
        ...
        const b = world.createRigidBody(RAPIER.RigidBodyDesc.fixed().setTranslation(10, 0));
