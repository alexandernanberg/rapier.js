...
export class KinematicCharacterController {
    ...
    public computedCollision(i: number, target: CharacterCollision): CharacterCollision | null {
        if (!this.raw.computedCollision(i, this.rawCharacterCollision)) {
            ...
            target.witness1 = VectorOps.fromBufferAt(s, 5, target.witness1);
            target.witness2 = VectorOps.fromBufferAt(s, 7, target.witness2);
            target.normal1 = VectorOps.fromBufferAt(s, 9, target.normal1);
            target.normal2 = VectorOps.fromBufferAt(s, 11, target.normal2);
