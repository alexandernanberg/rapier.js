...
export class KinematicCharacterController {
    ...
    public computedCollision(i: number, out?: CharacterCollision): CharacterCollision | null {
        if (!this.raw.computedCollision(i, this.rawCharacterCollision)) {
            ...
            out.witness1 = VectorOps.fromBufferAt(_scratch, 5, out.witness1);
            out.witness2 = VectorOps.fromBufferAt(_scratch, 7, out.witness2);
            out.normal1 = VectorOps.fromBufferAt(_scratch, 9, out.normal1);
            out.normal2 = VectorOps.fromBufferAt(_scratch, 11, out.normal2);
