/* @ts-self-types="./rapier_wasm_2d.d.ts" */
...
export class RawBroadPhase {
     ...
     */
    castShape(narrow_phase, bodies, colliders, pos_x, pos_y, rot, vel_x, vel_y, shape, target_distance, maxToi, stop_at_penetration, filter_flags, filter_groups, filter_exclude_collider, filter_exclude_rigid_body, filter_predicate) {
        try {
            ...
            wasm.rawbroadphase_castShape(retptr, this.__wbg_ptr, narrow_phase.__wbg_ptr, bodies.__wbg_ptr, colliders.__wbg_ptr, pos_x, pos_y, rot, vel_x, vel_y, shape.__wbg_ptr, target_distance, maxToi, stop_at_penetration, filter_flags, isLikeNone(filter_groups) ? Number.MAX_SAFE_INTEGER : (filter_groups) >>> 0, !isLikeNone(filter_exclude_collider), isLikeNone(filter_exclude_collider) ? 0 : filter_exclude_collider, !isLikeNone(filter_exclude_rigid_body), isLikeNone(filter_exclude_rigid_body) ? 0 : filter_exclude_rigid_body, addBorrowedObject(filter_predicate));
     ...
     */
    collidersWithAabbIntersectingAabb(narrow_phase, bodies, colliders, center_x, center_y, half_extents_x, half_extents_y, callback) {
        try {
            _assertClass(narrow_phase, RawNarrowPhase);
            _assertClass(bodies, RawRigidBodySet);
            _assertClass(colliders, RawColliderSet);
            wasm.rawbroadphase_collidersWithAabbIntersectingAabb(this.__wbg_ptr, narrow_phase.__wbg_ptr, bodies.__wbg_ptr, colliders.__wbg_ptr, center_x, center_y, half_extents_x, half_extents_y, addBorrowedObject(callback));
        } finally {
            heap[stack_pointer++] = undefined;
        }
    }
     ...
     * @returns {number | undefined}
     */
    intersectionWithShape(narrow_phase, bodies, colliders, pos_x, pos_y, rot, shape, filter_flags, filter_groups, filter_exclude_collider, filter_exclude_rigid_body, filter_predicate) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            _assertClass(narrow_phase, RawNarrowPhase);
            _assertClass(bodies, RawRigidBodySet);
     ...
     * @param {Function} filter_predicate
     */
    intersectionsWithRay(narrow_phase, bodies, colliders, ray_ox, ray_oy, ray_dx, ray_dy, maxToi, solid, callback, filter_flags, filter_groups, filter_exclude_collider, filter_exclude_rigid_body, filter_predicate) {
        try {
            _assertClass(narrow_phase, RawNarrowPhase);
            _assertClass(bodies, RawRigidBodySet);
            _assertClass(colliders, RawColliderSet);
     ...
     * @param {Function} filter_predicate
     */
    intersectionsWithShape(narrow_phase, bodies, colliders, pos_x, pos_y, rot, shape, callback, filter_flags, filter_groups, filter_exclude_collider, filter_exclude_rigid_body, filter_predicate) {
        try {
            _assertClass(narrow_phase, RawNarrowPhase);
            _assertClass(bodies, RawRigidBodySet);
            _assertClass(colliders, RawColliderSet);
            _assertClass(shape, RawShape);
            wasm.rawbroadphase_intersectionsWithShape(this.__wbg_ptr, narrow_phase.__wbg_ptr, bodies.__wbg_ptr, colliders.__wbg_ptr, pos_x, pos_y, rot, shape.__wbg_ptr, addBorrowedObject(callback), filter_flags, isLikeNone(filter_groups) ? Number.MAX_SAFE_INTEGER : (filter_groups) >>> 0, !isLikeNone(filter_exclude_collider), isLikeNone(filter_exclude_collider) ? 0 : filter_exclude_collider, !isLikeNone(filter_exclude_rigid_body), isLikeNone(filter_exclude_rigid_body) ? 0 : filter_exclude_rigid_body, addBorrowedObject(filter_predicate));
        } finally {
            heap[stack_pointer++] = undefined;
            heap[stack_pointer++] = undefined;
        }
...
export class RawColliderSet {
     ...
     * @returns {boolean}
     */
    coCastCollider(handle, vel1_x, vel1_y, collider2handle, vel2_x, vel2_y, target_distance, max_toi, stop_at_penetration) {
        const ret = wasm.rawcolliderset_coCastCollider(this.__wbg_ptr, handle, vel1_x, vel1_y, collider2handle, vel2_x, vel2_y, target_distance, max_toi, stop_at_penetration);
        return ret !== 0;
    }
    /**
     ...
     * @returns {number}
     */
    coCastRay(handle, ox, oy, dx, dy, maxToi, solid) {
        const ret = wasm.rawcolliderset_coCastRay(this.__wbg_ptr, handle, ox, oy, dx, dy, maxToi, solid);
        return ret;
    }
    /**
     ...
     * @returns {boolean}
     */
    coCastRayAndGetNormal(handle, ox, oy, dx, dy, maxToi, solid) {
        const ret = wasm.rawcolliderset_coCastRayAndGetNormal(this.__wbg_ptr, handle, ox, oy, dx, dy, maxToi, solid);
        return ret !== 0;
    }
    /**
     ...
     * @returns {boolean}
     */
    coCastShape(handle, vel1_x, vel1_y, shape2, pos2_x, pos2_y, rot2, vel2_x, vel2_y, target_distance, maxToi, stop_at_penetration) {
        _assertClass(shape2, RawShape);
        const ret = wasm.rawcolliderset_coCastShape(this.__wbg_ptr, handle, vel1_x, vel1_y, shape2.__wbg_ptr, pos2_x, pos2_y, rot2, vel2_x, vel2_y, target_distance, maxToi, stop_at_penetration);
        return ret !== 0;
    }
    /**
     ...
     * @returns {boolean}
     */
    coContactShape(handle, shape2, pos2_x, pos2_y, rot2, prediction) {
        _assertClass(shape2, RawShape);
        const ret = wasm.rawcolliderset_coContactShape(this.__wbg_ptr, handle, shape2.__wbg_ptr, pos2_x, pos2_y, rot2, prediction);
        return ret !== 0;
    }
    /**
     * @param {number} handle
     ...
     * @returns {boolean}
     */
    coContainsPoint(handle, px, py) {
        const ret = wasm.rawcolliderset_coContainsPoint(this.__wbg_ptr, handle, px, py);
        return ret !== 0;
    }
    /**
     ...
     * @returns {boolean}
     */
    coIntersectsRay(handle, ox, oy, dx, dy, maxToi) {
        const ret = wasm.rawcolliderset_coIntersectsRay(this.__wbg_ptr, handle, ox, oy, dx, dy, maxToi);
        return ret !== 0;
    }
    /**
     * @param {number} handle
     ...
     * @returns {boolean}
     */
    coIntersectsShape(handle, shape2, pos2_x, pos2_y, rot2) {
        _assertClass(shape2, RawShape);
        const ret = wasm.rawcolliderset_coIntersectsShape(this.__wbg_ptr, handle, shape2.__wbg_ptr, pos2_x, pos2_y, rot2);
        return ret !== 0;
    }
    /**
     * @param {number} handle
     ...
     * @param {boolean} solid
     */
    coProjectPoint(handle, px, py, solid) {
        wasm.rawcolliderset_coProjectPoint(this.__wbg_ptr, handle, px, py, solid);
    }
    /**
     * @param {number} handle1
     * @param {number} handle2
...
export class RawContactModificationContext {
     ...
     */
    setNormal(x, y) {
        wasm.rawcontactmodificationcontext_setNormal(this.__wbg_ptr, x, y);
    }
    /**
     * @param {number} restitution
     */
     ...
     * @param {number} y
     */
    setSolverContactPoint1(i, x, y) {
        wasm.rawcontactmodificationcontext_setSolverContactPoint1(this.__wbg_ptr, i, x, y);
    }
    /**
     * @param {number} i
     * @param {number} x
     * @param {number} y
     */
    setSolverContactPoint2(i, x, y) {
        wasm.rawcontactmodificationcontext_setSolverContactPoint2(this.__wbg_ptr, i, x, y);
    }
    /**
     ...
     * @param {number} y
     */
    setSolverContactTangentVelocity(i, x, y) {
        wasm.rawcontactmodificationcontext_setSolverContactTangentVelocity(this.__wbg_ptr, i, x, y);
    }
    /**
...
export class RawRigidBodySet {
     ...
     * @param {boolean} wakeUp
     */
    rbAddForce(handle, x, y, wakeUp) {
        wasm.rawrigidbodyset_rbAddForce(this.__wbg_ptr, handle, x, y, wakeUp);
    }
    /**
     ...
     * @param {boolean} wakeUp
     */
    rbAddForceAtPoint(handle, fx, fy, px, py, wakeUp) {
        wasm.rawrigidbodyset_rbAddForceAtPoint(this.__wbg_ptr, handle, fx, fy, px, py, wakeUp);
    }
    /**
     ...
     * @param {boolean} wakeUp
     */
    rbApplyImpulse(handle, x, y, wakeUp) {
        wasm.rawrigidbodyset_rbApplyImpulse(this.__wbg_ptr, handle, x, y, wakeUp);
    }
    /**
     ...
     * @param {boolean} wakeUp
     */
    rbApplyImpulseAtPoint(handle, ix, iy, px, py, wakeUp) {
        wasm.rawrigidbodyset_rbApplyImpulseAtPoint(this.__wbg_ptr, handle, ix, iy, px, py, wakeUp);
    }
    /**
     ...
     * @param {boolean} wakeUp
     */
    rbSetLinvel(handle, x, y, wakeUp) {
        wasm.rawrigidbodyset_rbSetLinvel(this.__wbg_ptr, handle, x, y, wakeUp);
    }
    /**
     ...
     * @param {number} angle
     */
    rbSetNextKinematicTransform(handle, tx, ty, angle) {
        wasm.rawrigidbodyset_rbSetNextKinematicTransform(this.__wbg_ptr, handle, tx, ty, angle);
    }
    /**
     ...
     * @param {boolean} wakeUp
     */
    rbSetTransform(handle, tx, ty, angle, wakeUp) {
        wasm.rawrigidbodyset_rbSetTransform(this.__wbg_ptr, handle, tx, ty, angle, wakeUp);
    }
    /**
     ...
     * @param {number} py
     */
    rbVelocityAtPoint(handle, px, py) {
        wasm.rawrigidbodyset_rbVelocityAtPoint(this.__wbg_ptr, handle, px, py);
    }
    /**
...
export class RawShape {
     ...
     * @returns {number}
     */
    castRay(pos_x, pos_y, rot, orig_x, orig_y, dir_x, dir_y, maxToi, solid) {
        const ret = wasm.rawshape_castRay(this.__wbg_ptr, pos_x, pos_y, rot, orig_x, orig_y, dir_x, dir_y, maxToi, solid);
        return ret;
    }
    /**
     ...
     * @returns {boolean}
     */
    castRayAndGetNormal(pos_x, pos_y, rot, orig_x, orig_y, dir_x, dir_y, maxToi, solid) {
        const ret = wasm.rawshape_castRayAndGetNormal(this.__wbg_ptr, pos_x, pos_y, rot, orig_x, orig_y, dir_x, dir_y, maxToi, solid);
        return ret !== 0;
    }
    /**
     ...
     * @returns {boolean}
     */
    castShape(pos1_x, pos1_y, rot1, vel1_x, vel1_y, shape2, pos2_x, pos2_y, rot2, vel2_x, vel2_y, target_distance, maxToi, stop_at_penetration) {
        _assertClass(shape2, RawShape);
        const ret = wasm.rawshape_castShape(this.__wbg_ptr, pos1_x, pos1_y, rot1, vel1_x, vel1_y, shape2.__wbg_ptr, pos2_x, pos2_y, rot2, vel2_x, vel2_y, target_distance, maxToi, stop_at_penetration);
        return ret !== 0;
    }
    /**
     ...
     * @returns {boolean}
     */
    contactShape(pos1_x, pos1_y, rot1, shape2, pos2_x, pos2_y, rot2, prediction) {
        _assertClass(shape2, RawShape);
        const ret = wasm.rawshape_contactShape(this.__wbg_ptr, pos1_x, pos1_y, rot1, shape2.__wbg_ptr, pos2_x, pos2_y, rot2, prediction);
        return ret !== 0;
    }
    /**
     * @param {number} pos_x
     ...
     * @returns {boolean}
     */
    containsPoint(pos_x, pos_y, rot, point_x, point_y) {
        const ret = wasm.rawshape_containsPoint(this.__wbg_ptr, pos_x, pos_y, rot, point_x, point_y);
        return ret !== 0;
    }
    /**
     ...
     * @returns {boolean}
     */
    intersectsRay(pos_x, pos_y, rot, orig_x, orig_y, dir_x, dir_y, maxToi) {
        const ret = wasm.rawshape_intersectsRay(this.__wbg_ptr, pos_x, pos_y, rot, orig_x, orig_y, dir_x, dir_y, maxToi);
        return ret !== 0;
    }
    /**
     * @param {number} pos1_x
     ...
     * @returns {boolean}
     */
    intersectsShape(pos1_x, pos1_y, rot1, shape2, pos2_x, pos2_y, rot2) {
        _assertClass(shape2, RawShape);
        const ret = wasm.rawshape_intersectsShape(this.__wbg_ptr, pos1_x, pos1_y, rot1, shape2.__wbg_ptr, pos2_x, pos2_y, rot2);
        return ret !== 0;
    }
    /**
     ...
     * @param {boolean} solid
     */
    projectPoint(pos_x, pos_y, rot, point_x, point_y, solid) {
        wasm.rawshape_projectPoint(this.__wbg_ptr, pos_x, pos_y, rot, point_x, point_y, solid);
    }
    /**
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('rapier_wasm_2d_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
