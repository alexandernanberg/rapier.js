...
export class KinematicCharacterController {
    ...
    public setUp(vector: Vector) {
        this.raw.setUp(vector.x, vector.y, vector.z);
    }
    ...
    public computedCollision(i: number, out?: CharacterCollision): CharacterCollision | null {
        ...
        out.translationDeltaRemaining = VectorOps.fromBufferAt(s, 4, out.translationDeltaRemaining);
        ...
        out.collider = this.colliders.get(handleFromParts(u32[19], u32[20]));
        return out;
    }
}
