...
export enum JointAxesMask {
    ...
    AngY = 1 << 4,
    AngZ = 1 << 5,
    AllLin = JointAxesMask.LinX | JointAxesMask.LinY | JointAxesMask.LinZ,
    AllAng = JointAxesMask.AngX | JointAxesMask.AngY | JointAxesMask.AngZ,
    All = JointAxesMask.AllLin | JointAxesMask.AllAng,
}
