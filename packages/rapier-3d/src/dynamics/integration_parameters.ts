 ...
 */
export enum FrictionModel {
    /**
     * A simplified friction model: one Coulomb friction constraint per group of
     * contacts, plus one twist constraint. Faster to solve than {@link FrictionModel.Coulomb},
     * but less accurate.
     */
    Simplified = 0,
    /**
     * The Coulomb friction model: one friction constraint per contact point.
     */
    Coulomb = 1,
}
...
export class IntegrationParameters {
    ...
    /**
     * The friction constraint model used by the solver (default: {@link FrictionModel.Simplified}).
     */
    get frictionModel(): FrictionModel {
        return this.raw.frictionModel as number as FrictionModel;
    }
    ...
    set frictionModel(value: FrictionModel) {
        this.raw.frictionModel = value as number as RawFrictionModel;
    }
}
