...
import type {ShapeType, TriMeshFlags, HeightFieldFlags} from "./shape";
 ...
 * Layout: translation(3) + rotation(4) = 7
 */
const COLLIDER_TRANSFORM_STRIDE = 7;
...
export class ColliderDesc {
     ...
     * decomposition of the given triangle mesh.
     *
