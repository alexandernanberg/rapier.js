...
export class RawBroadPhase {
     ...
     * @param {Function} filter_predicate
     */
    intersectionsWithPoint(narrow_phase, bodies, colliders, point_x, point_y, point_z, callback, filter_flags, filter_groups, filter_exclude_collider, filter_exclude_rigid_body, filter_predicate) {
        try {
            _assertClass(narrow_phase, RawNarrowPhase);
            _assertClass(bodies, RawRigidBodySet);
            _assertClass(colliders, RawColliderSet);
    ...
    intersectionsWithRay(narrow_phase, bodies, colliders, ray_ox, ray_oy, ray_oz, ray_dx, ray_dy, ray_dz, maxToi, solid, callback, filter_flags, filter_groups, filter_exclude_collider, filter_exclude_rigid_body, filter_predicate) {
        try {
            ...
            _assertClass(bodies, RawRigidBodySet);
            _assertClass(colliders, RawColliderSet);
            wasm.rawbroadphase_intersectionsWithRay(this.__wbg_ptr, narrow_phase.__wbg_ptr, bodies.__wbg_ptr, colliders.__wbg_ptr, ray_ox, ray_oy, ray_oz, ray_dx, ray_dy, ray_dz, maxToi, solid, addBorrowedObject(callback), filter_flags, isLikeNone(filter_groups) ? Number.MAX_SAFE_INTEGER : (filter_groups) >>> 0, !isLikeNone(filter_exclude_collider), isLikeNone(filter_exclude_collider) ? 0 : filter_exclude_collider, !isLikeNone(filter_exclude_rigid_body), isLikeNone(filter_exclude_rigid_body) ? 0 : filter_exclude_rigid_body, addBorrowedObject(filter_predicate));
        } finally {
            heap[stack_pointer++] = undefined;
            heap[stack_pointer++] = undefined;
        }
     ...
     * @returns {boolean}
     */
    projectPoint(narrow_phase, bodies, colliders, point_x, point_y, point_z, solid, filter_flags, filter_groups, filter_exclude_collider, filter_exclude_rigid_body, filter_predicate) {
        try {
            _assertClass(narrow_phase, RawNarrowPhase);
            _assertClass(bodies, RawRigidBodySet);
            _assertClass(colliders, RawColliderSet);
     ...
     * @returns {boolean}
     */
    projectPointAndGetFeature(narrow_phase, bodies, colliders, point_x, point_y, point_z, filter_flags, filter_groups, filter_exclude_collider, filter_exclude_rigid_body, filter_predicate) {
        try {
            _assertClass(narrow_phase, RawNarrowPhase);
            _assertClass(bodies, RawRigidBodySet);
            _assertClass(colliders, RawColliderSet);
            const ret = wasm.rawbroadphase_projectPointAndGetFeature(this.__wbg_ptr, narrow_phase.__wbg_ptr, bodies.__wbg_ptr, colliders.__wbg_ptr, point_x, point_y, point_z, filter_flags, isLikeNone(filter_groups) ? Number.MAX_SAFE_INTEGER : (filter_groups) >>> 0, !isLikeNone(filter_exclude_collider), isLikeNone(filter_exclude_collider) ? 0 : filter_exclude_collider, !isLikeNone(filter_exclude_rigid_body), isLikeNone(filter_exclude_rigid_body) ? 0 : filter_exclude_rigid_body, addBorrowedObject(filter_predicate));
            return ret !== 0;
        } finally {
            heap[stack_pointer++] = undefined;
        }
...
export class RawColliderSet {
     ...
     */
    coRotation(handle) {
        wasm.rawcolliderset_coRotation(this.__wbg_ptr, handle);
    }
    /**
     ...
     * @param {number} centerOfMass_z
     * @param {number} principalAngularInertia_x
     * @param {number} principalAngularInertia_y
     * @param {number} principalAngularInertia_z
     * @param {number} angularInertiaFrame_x
     * @param {number} angularInertiaFrame_y
     * @param {number} angularInertiaFrame_z
     * @param {number} angularInertiaFrame_w
     */
    coSetMassProperties(handle, mass, centerOfMass_x, centerOfMass_y, centerOfMass_z, principalAngularInertia_x, principalAngularInertia_y, principalAngularInertia_z, angularInertiaFrame_x, angularInertiaFrame_y, angularInertiaFrame_z, angularInertiaFrame_w) {
        wasm.rawcolliderset_coSetMassProperties(this.__wbg_ptr, handle, mass, centerOfMass_x, centerOfMass_y, centerOfMass_z, principalAngularInertia_x, principalAngularInertia_y, principalAngularInertia_z, angularInertiaFrame_x, angularInertiaFrame_y, angularInertiaFrame_z, angularInertiaFrame_w);
    }
    /**
    ...
    coTranslation(handle) {
        wasm.rawcolliderset_coTranslation(this.__wbg_ptr, handle);
    }
    /**
     ...
     * @returns {number | undefined}
     */
    createCollider(enabled, shape, translation_x, translation_y, translation_z, rotation_x, rotation_y, rotation_z, rotation_w, massPropsMode, mass, centerOfMass_x, centerOfMass_y, centerOfMass_z, principalAngularInertia_x, principalAngularInertia_y, principalAngularInertia_z, angularInertiaFrame_x, angularInertiaFrame_y, angularInertiaFrame_z, angularInertiaFrame_w, density, friction, restitution, frictionCombineRule, restitutionCombineRule, isSensor, collisionGroups, solverGroups, activeCollisionTypes, activeHooks, activeEvents, contactForceEventThreshold, contactSkin, hasParent, parent, bodies) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            _assertClass(shape, RawShape);
            _assertClass(bodies, RawRigidBodySet);
            wasm.rawcolliderset_createCollider(retptr, this.__wbg_ptr, enabled, shape.__wbg_ptr, translation_x, translation_y, translation_z, rotation_x, rotation_y, rotation_z, rotation_w, massPropsMode, mass, centerOfMass_x, centerOfMass_y, centerOfMass_z, principalAngularInertia_x, principalAngularInertia_y, principalAngularInertia_z, angularInertiaFrame_x, angularInertiaFrame_y, angularInertiaFrame_z, angularInertiaFrame_w, density, friction, restitution, frictionCombineRule, restitutionCombineRule, isSensor, collisionGroups, solverGroups, activeCollisionTypes, activeHooks, activeEvents, contactForceEventThreshold, contactSkin, hasParent, parent, bodies.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r2 = getDataViewMemory0().getFloat64(retptr + 8 * 1, true);
            return r0 === 0 ? undefined : r2;
        } finally {
     ...
     */
    transformBufferInfo() {
        const ret = wasm.rawcolliderset_transformBufferInfo(this.__wbg_ptr);
        return ret;
    }
    /**
     ...
     * @returns {number}
     */
    transformBufferStride() {
        const ret = wasm.rawcolliderset_transformBufferStride(this.__wbg_ptr);
        return ret >>> 0;
    }
}
...
export class RawDynamicRayCastVehicleController {
     ...
     * @param {number} chassis_connection_cs_x
     * @param {number} chassis_connection_cs_y
     * @param {number} chassis_connection_cs_z
     * @param {number} direction_cs_x
     * @param {number} direction_cs_y
     * @param {number} direction_cs_z
     * @param {number} axle_cs_x
     * @param {number} axle_cs_y
     * @param {number} axle_cs_z
     * @param {number} suspension_rest_length
     * @param {number} radius
     */
    add_wheel(chassis_connection_cs_x, chassis_connection_cs_y, chassis_connection_cs_z, direction_cs_x, direction_cs_y, direction_cs_z, axle_cs_x, axle_cs_y, axle_cs_z, suspension_rest_length, radius) {
        wasm.rawdynamicraycastvehiclecontroller_add_wheel(this.__wbg_ptr, chassis_connection_cs_x, chassis_connection_cs_y, chassis_connection_cs_z, direction_cs_x, direction_cs_y, direction_cs_z, axle_cs_x, axle_cs_y, axle_cs_z, suspension_rest_length, radius);
    }
    /**
     * @returns {number}
     */
     ...
     * @param {number} z
     */
    set_wheel_axle_cs(i, x, y, z) {
        wasm.rawdynamicraycastvehiclecontroller_set_wheel_axle_cs(this.__wbg_ptr, i, x, y, z);
    }
    /**
     * @param {number} i
     * @param {number} value
     ...
     * @param {number} z
     */
    set_wheel_chassis_connection_point_cs(i, x, y, z) {
        wasm.rawdynamicraycastvehiclecontroller_set_wheel_chassis_connection_point_cs(this.__wbg_ptr, i, x, y, z);
    }
    /**
     * @param {number} i
     * @param {number} x
     ...
     * @param {number} z
     */
    set_wheel_direction_cs(i, x, y, z) {
        wasm.rawdynamicraycastvehiclecontroller_set_wheel_direction_cs(this.__wbg_ptr, i, x, y, z);
    }
    /**
     * @param {number} i
     * @param {number} value
...
export class RawImpulseJointSet {
     ...
     * @param {number} z
     */
    jointSetAnchor1(handle, x, y, z) {
        wasm.rawimpulsejointset_jointSetAnchor1(this.__wbg_ptr, handle, x, y, z);
    }
    /**
     ...
     * @param {number} z
     */
    jointSetAnchor2(handle, x, y, z) {
        wasm.rawimpulsejointset_jointSetAnchor2(this.__wbg_ptr, handle, x, y, z);
    }
    /**
     ...
     * @param {number} w
     */
    jointSetFrameX1(handle, x, y, z, w) {
        wasm.rawimpulsejointset_jointSetFrameX1(this.__wbg_ptr, handle, x, y, z, w);
    }
    /**
     ...
     * @param {number} w
     */
    jointSetFrameX2(handle, x, y, z, w) {
        wasm.rawimpulsejointset_jointSetFrameX2(this.__wbg_ptr, handle, x, y, z, w);
    }
    /**
     ...
     * @param {number} rot_w
     */
    jointSetLocalFrame1(handle, anchor_x, anchor_y, anchor_z, rot_x, rot_y, rot_z, rot_w) {
        wasm.rawimpulsejointset_jointSetLocalFrame1(this.__wbg_ptr, handle, anchor_x, anchor_y, anchor_z, rot_x, rot_y, rot_z, rot_w);
    }
    /**
     ...
     * @param {number} rot_w
     */
    jointSetLocalFrame2(handle, anchor_x, anchor_y, anchor_z, rot_x, rot_y, rot_z, rot_w) {
        wasm.rawimpulsejointset_jointSetLocalFrame2(this.__wbg_ptr, handle, anchor_x, anchor_y, anchor_z, rot_x, rot_y, rot_z, rot_w);
    }
    /**
...
export class RawKinematicCharacterController {
     ...
     */
    computedMovement() {
        wasm.rawkinematiccharactercontroller_computedMovement(this.__wbg_ptr);
    }
    disableAutostep() {
     ...
     */
    setUp(x, y, z) {
        wasm.rawkinematiccharactercontroller_setUp(this.__wbg_ptr, x, y, z);
    }
    /**
     * @returns {boolean}
     */
...
export class RawRigidBodySet {
     ...
     * @param {number} linvel_z
     * @param {number} angvel_x
     * @param {number} angvel_y
     * @param {number} angvel_z
     * @param {number} principalAngularInertia_x
     * @param {number} principalAngularInertia_y
     * @param {number} principalAngularInertia_z
     * @param {number} angularInertiaFrame_x
     ...
     * @returns {number}
     */
    createRigidBody(enabled, translation_x, translation_y, translation_z, rotation_x, rotation_y, rotation_z, rotation_w, gravityScale, mass, massOnly, centerOfMass_x, centerOfMass_y, centerOfMass_z, linvel_x, linvel_y, linvel_z, angvel_x, angvel_y, angvel_z, principalAngularInertia_x, principalAngularInertia_y, principalAngularInertia_z, angularInertiaFrame_x, angularInertiaFrame_y, angularInertiaFrame_z, angularInertiaFrame_w, translationEnabledX, translationEnabledY, translationEnabledZ, rotationEnabledX, rotationEnabledY, rotationEnabledZ, linearDamping, angularDamping, rb_type, canSleep, sleeping, softCcdPrediction, ccdEnabled, dominanceGroup, additional_solver_iterations) {
        const ret = wasm.rawrigidbodyset_createRigidBody(this.__wbg_ptr, enabled, translation_x, translation_y, translation_z, rotation_x, rotation_y, rotation_z, rotation_w, gravityScale, mass, massOnly, centerOfMass_x, centerOfMass_y, centerOfMass_z, linvel_x, linvel_y, linvel_z, angvel_x, angvel_y, angvel_z, principalAngularInertia_x, principalAngularInertia_y, principalAngularInertia_z, angularInertiaFrame_x, angularInertiaFrame_y, angularInertiaFrame_z, angularInertiaFrame_w, translationEnabledX, translationEnabledY, translationEnabledZ, rotationEnabledX, rotationEnabledY, rotationEnabledZ, linearDamping, angularDamping, rb_type, canSleep, sleeping, softCcdPrediction, ccdEnabled, dominanceGroup, additional_solver_iterations);
        return ret;
    }
    /**
     ...
     * @param {boolean} wakeUp
     */
    rbAddForce(handle, x, y, z, wakeUp) {
        wasm.rawrigidbodyset_rbAddForce(this.__wbg_ptr, handle, x, y, z, wakeUp);
    }
    /**
     ...
     * @param {boolean} wakeUp
     */
    rbAddForceAtPoint(handle, fx, fy, fz, px, py, pz, wakeUp) {
        wasm.rawrigidbodyset_rbAddForceAtPoint(this.__wbg_ptr, handle, fx, fy, fz, px, py, pz, wakeUp);
    }
    /**
     ...
     * @param {boolean} wakeUp
     */
    rbAddTorque(handle, x, y, z, wakeUp) {
        wasm.rawrigidbodyset_rbAddTorque(this.__wbg_ptr, handle, x, y, z, wakeUp);
    }
    /**
     * @param {number} handle
     * @returns {number}
     ...
     */
    rbAngvel(handle) {
        wasm.rawrigidbodyset_rbAngvel(this.__wbg_ptr, handle);
    }
    /**
     ...
     * @param {boolean} wakeUp
     */
    rbApplyImpulse(handle, x, y, z, wakeUp) {
        wasm.rawrigidbodyset_rbApplyImpulse(this.__wbg_ptr, handle, x, y, z, wakeUp);
    }
    /**
     ...
     * @param {boolean} wakeUp
     */
    rbApplyImpulseAtPoint(handle, ix, iy, iz, px, py, pz, wakeUp) {
        wasm.rawrigidbodyset_rbApplyImpulseAtPoint(this.__wbg_ptr, handle, ix, iy, iz, px, py, pz, wakeUp);
    }
    /**
     ...
     * @param {boolean} wakeUp
     */
    rbApplyTorqueImpulse(handle, x, y, z, wakeUp) {
        wasm.rawrigidbodyset_rbApplyTorqueImpulse(this.__wbg_ptr, handle, x, y, z, wakeUp);
    }
    /**
     ...
     */
    rbLinvel(handle) {
        wasm.rawrigidbodyset_rbLinvel(this.__wbg_ptr, handle);
    }
    /**
     ...
     */
    rbLocalCom(handle) {
        wasm.rawrigidbodyset_rbLocalCom(this.__wbg_ptr, handle);
    }
    /**
     * @param {number} handle
    ...
    rbNextRotation(handle) {
        wasm.rawrigidbodyset_rbNextRotation(this.__wbg_ptr, handle);
    }
    /**
    ...
    rbNextTranslation(handle) {
        wasm.rawrigidbodyset_rbNextTranslation(this.__wbg_ptr, handle);
    }
    /**
     ...
     */
    rbRotation(handle) {
        wasm.rawrigidbodyset_rbRotation(this.__wbg_ptr, handle);
    }
    /**
     * @param {number} handle
     * @param {number} mass
     ...
     * @param {boolean} wake_up
     */
    rbSetAdditionalMassProperties(handle, mass, centerOfMass_x, centerOfMass_y, centerOfMass_z, principalAngularInertia_x, principalAngularInertia_y, principalAngularInertia_z, angularInertiaFrame_x, angularInertiaFrame_y, angularInertiaFrame_z, angularInertiaFrame_w, wake_up) {
        wasm.rawrigidbodyset_rbSetAdditionalMassProperties(this.__wbg_ptr, handle, mass, centerOfMass_x, centerOfMass_y, centerOfMass_z, principalAngularInertia_x, principalAngularInertia_y, principalAngularInertia_z, angularInertiaFrame_x, angularInertiaFrame_y, angularInertiaFrame_z, angularInertiaFrame_w, wake_up);
    }
    /**
     * @param {number} handle
     * @param {number} iters
     ...
     * @param {boolean} wakeUp
     */
    rbSetAngvel(handle, x, y, z, wakeUp) {
        wasm.rawrigidbodyset_rbSetAngvel(this.__wbg_ptr, handle, x, y, z, wakeUp);
    }
    /**
     ...
     * @param {boolean} wakeUp
     */
    rbSetLinvel(handle, x, y, z, wakeUp) {
        wasm.rawrigidbodyset_rbSetLinvel(this.__wbg_ptr, handle, x, y, z, wakeUp);
    }
    /**
     ...
     */
    rbWorldCom(handle) {
        wasm.rawrigidbodyset_rbWorldCom(this.__wbg_ptr, handle);
    }
    /**
     * @param {number} handle
     * @param {RawIslandManager} islands
     ...
     */
    transformBufferInfo() {
        const ret = wasm.rawrigidbodyset_transformBufferInfo(this.__wbg_ptr);
        return ret;
    }
    /**
     ...
     */
    transformBufferStride() {
        const ret = wasm.rawrigidbodyset_transformBufferStride(this.__wbg_ptr);
        return ret >>> 0;
    }
}
